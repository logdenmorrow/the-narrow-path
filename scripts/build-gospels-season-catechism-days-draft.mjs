...
const CATECHISM_PROMPTS = new Map([
  [6, "Ask the Holy Spirit to make the Gospels a real encounter with Christ this week."],
  [13, "Pray the name of Jesus slowly, and ask for deeper faith in Him as Lord and Son."],
  [20, "Thank Christ for taking on our humanity, then honor Him in one ordinary duty today."],
  [27, "Ask Mary to teach you a freer yes to God in the place where you hesitate."],
  [34, "Renew your baptismal identity, and resist one temptation with Christ today."],
  [41, "Ask Christ to reign more fully in one concrete part of your life this week."],
  [48, "Bring one need to Jesus with trust, and look for the mercy His signs reveal."],
  [55, "Ask Jesus to make you a disciple who stays close and is ready to be sent."],
  [62, "Pray for the Church, the Pope, and the grace to receive Christ's authority with faith."],
  [69, "Listen to the beloved Son today, especially where His words challenge your comfort."],
  [76, "Ask Jesus to purify how you read conflict, authority, and fulfillment in the Gospels."],
  [83, "Place one sin or burden before the crucified Lord, and receive His mercy with honesty."],
  [90, "Stay with Christ in His burial, and ask for patient faith where God seems hidden."],
  [97, "Ask the risen Lord to strengthen your hope and make your faith more visible in charity."],
  [104, "Entrust this week to Christ who reigns and intercedes for His Church."],
  [111, "Ask for love for the Church Christ gathers, teaches, and sends into the world."],
  [118, "Name one way you can serve Christ's Body with humility and real charity."],
  [125, "Ask for deeper trust in the one, holy, catholic, and apostolic Church Christ gives us."],
  [132, "Ask Mary to help you receive Jesus faithfully and follow Him as a disciple."],
  [139, "Renew your baptismal promises in one practical choice against sin today."],
  [146, "Ask Jesus to deepen your hunger for the Eucharist and your reverence for His gift."],
  [153, "Pray the Our Father slowly, and choose one way to live as a child of the Father."],
  [160, "Ask for true contrition and take one honest step toward Confession and Lent."],
]);
