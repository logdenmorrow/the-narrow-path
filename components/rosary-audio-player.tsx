...
export function RosaryAudioPlayer({ src }: RosaryAudioPlayerProps) {
  ...
  return (
    <div className="mt-5 rounded-[1.25rem] border border-[rgba(168,129,81,0.36)] bg-[linear-gradient(180deg,rgba(255,248,235,0.82),rgba(238,222,193,0.58))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.55),0_18px_34px_-30px_rgba(42,25,15,0.78)] dark:bg-[linear-gradient(180deg,rgba(49,34,23,0.82),rgba(32,24,19,0.74))] sm:p-5">
      <audio
        ref={audioRef}
        src={src}
        preload="metadata"
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center justify-between gap-3 text-xs font-semibold uppercase tracking-[0.16em] text-[#7b5430] dark:text-[#dcc39c]">
          ...
          <input
            ...
            className="mt-3 h-2 w-full cursor-pointer appearance-none rounded-full border border-[rgba(138,95,50,0.22)] bg-[rgba(168,129,81,0.18)] accent-[#8a5f32]"
            style={{
